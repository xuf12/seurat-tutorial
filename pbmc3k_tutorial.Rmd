...
resource_files:
- data/pbmc3k/filtered_gene_bc_matrices/hg19/matrix.mtx
- data/pbmc3k/filtered_gene_bc_matrices/hg19/genes.tsv
- data/pbmc3k/filtered_gene_bc_matrices/hg19/barcodes.tsv
---
...
# `{r save2, include = FALSE} # saveRDS(pbmc, file = "../data/pbmc3k_final.rds") #`
